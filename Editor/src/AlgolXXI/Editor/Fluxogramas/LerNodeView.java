 ...
 * @author Apocas
 */
public class LerNodeView extends VertexView {

    /**
     */
    public static transient LerRenderer renderer = new LerRenderer();
    ...
    /**
     */
    public LerNodeView(Object cell) {
        super(cell);
    }
    ...
    /**
     */
    public static class LerRenderer extends VertexRenderer {
        ...
        public void paint(Graphics g) {
            ...
            xCoord[0] = b / 2 + ((int) (getWidth() * 0.2));
            yCoord[0] = b / 2;
            xCoord[1] = b / 2 + getWidth() - 2;
            yCoord[1] = b / 2;
            xCoord[2] = b / 2 + getWidth() - ((int) (getWidth() * 0.2));
