 ...
 * @author Apocas
 */
public class DefeitoNodeView extends VertexView {

    /**
     */
    public static transient DefeitoRenderer renderer = new DefeitoRenderer();
    ...
    /**
     */
    public DefeitoNodeView() {
        super();
    }

    /**
     */
    public DefeitoNodeView(Object cell) {
        super(cell);
    }
    ...
    /**
     */
    public static class DefeitoRenderer extends VertexRenderer {
        ...
        public void paint(Graphics g) {
            ...
            int roundRectArc = LerNodeView.getArcSize(d.width - b,
                    d.height - b);
            if (super.isOpaque()) {
