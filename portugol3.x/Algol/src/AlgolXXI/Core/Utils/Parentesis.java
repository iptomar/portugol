...
/**
 * verifica a posi��o dos parentesis numa express�o
...
public class Parentesis {
    ...
    /**
     * calcula o erro de parentesis numa express�o
     * @param expr express�o a verificar
     * @return descri��io do erro
     */
