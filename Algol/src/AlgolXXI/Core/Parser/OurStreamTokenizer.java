 ...
 * 
 * Modificado por David Jardim e Edou Suilen para ser possível distinguir os tokens
 *  DOUBLE de INT.
 * 
 */
 ...
 * @since   JDK1.0
 */
public class OurStreamTokenizer {
    ...
    /**
     * numero do caracter (c) Manso 2008
     */
    ...
    public double nval;
    /**
     * Se o Token Actual for um número inteiro este campo possui o seu valor Inteiro          
     */
    public int ival;
    /**
     * Criamos um novo atributo para identificar se o numero é inteiro
     */
    public static final int TT_INT = -5;
    /**
     * * Criamos um novo atributo para identificar se o numero é Real
     */
    public static final int TT_DOUBLE = -6;

    /** Private constructor that initializes everything except the streams. */
    private OurStreamTokenizer() {
        wordChars('a', 'z');
        wordChars('A', 'Z');
     ...
     */
    @Deprecated
    public OurStreamTokenizer(InputStream is) {
        this();
        if (is == null) {
     ...
     * @since   JDK1.1
     */
    public OurStreamTokenizer(Reader r) {
        this();
        if (r == null) {
            throw new NullPointerException();
        }
