...
/**
 * Classe que permite definir as acções do botão Apagar
 * @author Apocas
 */
public final class Apaga extends CallableSystemAction {
    ...
    public String getName() {
        return NbBundle.getMessage(Apaga.class, "CTL_Apaga");
    }
    ...
    protected String iconResource() {
        return "AlgolXXI/Editor/Images/bin.png";
    }
