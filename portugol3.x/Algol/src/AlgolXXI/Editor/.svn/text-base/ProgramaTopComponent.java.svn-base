...
import AlgolXXI.Editor.Memory.DiagramaVenn;
...
public class ProgramaTopComponent extends TopComponent implements Runnable {
    ...
    private void initComponents() {
        ...
        panel_venn = new javax.swing.JPanel();
        ...
        panel_venn.setLayout(new java.awt.BorderLayout());
        output_tabpane.addTab("Testes", panel_venn);
...
private void under_tabpaneStateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_under_tabpaneStateChanged
    ...
    private void initializeExecutions() {
        if (panel_venn.getComponents().length == 0) {
            PApplet venn = new DiagramaVenn();
            panel_venn.add(venn, BorderLayout.CENTER);
            venn.init();
        }
...
//    }
    ...
    private javax.swing.JPanel panel_venn;
